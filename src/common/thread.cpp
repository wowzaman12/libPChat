...
#ifdef WIN32
	CloseHandle(CreateThread(nullptr, 0, (LPTHREAD_START_ROUTINE)start_routine, arg, 0, (DWORD*)&id));
#else
#ifdef USE_PTHREAD
	if (pthread_create(&id, nullptr, start_routine, arg) != 0)
		return 0;
#else
	switch (id = fork())
	{
